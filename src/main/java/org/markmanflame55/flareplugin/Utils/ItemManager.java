...
import org.markmanflame55.flareplugin.EventListeners.GrimArmorEvent;
...
public class ItemManager {
    ...
    public static void init() {
        ...
        createBloodBlade();
        createRefinedCopper();
        createRefinedCopperBlock();
        createGrimHelmet();
        createGrimChestplate();
        createGrimLeggings();
        createGrimBoots();
    }
    ...
    private static void createVampireSword() {

        SmithingTransformRecipe craftVampireSword = new SmithingTransformRecipe(NamespacedKey.minecraft("vampire_sword"), VampireSword.giveVampireSword(), new RecipeChoice.ExactChoice(VampireSword.giveBloodBlade()), new RecipeChoice.ExactChoice(new ItemStack(Material.IRON_SWORD)), new RecipeChoice.ExactChoice(RefinedGoldUtil.giveRefinedGold()));

        Bukkit.addRecipe(craftVampireSword);

    }
    private static void createBloodBlade() {
        ShapedRecipe craftBloodBlade = new ShapedRecipe(NamespacedKey.minecraft("blood_blade"), VampireSword.giveBloodBlade());

        craftBloodBlade.shape("FFF","FSF","FFF");
        craftBloodBlade.setIngredient('F', new RecipeChoice.ExactChoice(VampireSword.giveVampireFang()));
        craftBloodBlade.setIngredient('S', new RecipeChoice.ExactChoice(steelIngot));

        Bukkit.addRecipe(craftBloodBlade);
    }
    private static void createRefinedCopper(){
        ShapedRecipe craftRefinedCopper = new ShapedRecipe(NamespacedKey.minecraft("refined_copper"), RefinedCopperUtil.giveIngot());

        craftRefinedCopper.shape("   ","SCS","   ");
        craftRefinedCopper.setIngredient('S', new RecipeChoice.ExactChoice(steelIngot));
        craftRefinedCopper.setIngredient('C', Material.COPPER_BLOCK);

        Bukkit.addRecipe(craftRefinedCopper);
    }
    private static void createRefinedCopperBlock() {
        ShapedRecipe craftRefinedCopperBlock = new ShapedRecipe(NamespacedKey.minecraft("refiend_copper_block"), RefinedCopperUtil.giveBlock());

        craftRefinedCopperBlock.shape("CCC","CCC","CCC");
        craftRefinedCopperBlock.setIngredient('C', new RecipeChoice.ExactChoice(RefinedCopperUtil.giveIngot()));

        Bukkit.addRecipe(craftRefinedCopperBlock);
    }
    private static void createGrimHelmet(){
        ShapedRecipe craftGrimHelmet = new ShapedRecipe(NamespacedKey.minecraft("grim_helmet"), GrimReaperArmorUtil.giveGrimHelmet());

        craftGrimHelmet.shape("CIC","C C","   ");
        craftGrimHelmet.setIngredient('C', new RecipeChoice.ExactChoice(GrimReaperArmorUtil.giveUndeadChains()));
        craftGrimHelmet.setIngredient('I', new RecipeChoice.ExactChoice(RefinedCopperUtil.giveIngot()));

        Bukkit.addRecipe(craftGrimHelmet);
    }
    private static void createGrimChestplate() {
        ShapedRecipe craftGrimChestplate = new ShapedRecipe(NamespacedKey.minecraft("grim_chestplate"), GrimReaperArmorUtil.giveGrimChestplate());

        craftGrimChestplate.shape("I I","CIC","CCC");
        craftGrimChestplate.setIngredient('I', new RecipeChoice.ExactChoice(RefinedCopperUtil.giveIngot()));
        craftGrimChestplate.setIngredient('C',new RecipeChoice.ExactChoice(GrimReaperArmorUtil.giveUndeadChains()));

        Bukkit.getServer().addRecipe(craftGrimChestplate);
    }
    private static void createGrimLeggings(){
        ShapedRecipe craftGrimLeggings = new ShapedRecipe(NamespacedKey.minecraft("grim_leggings"), GrimReaperArmorUtil.giveGrimLeggings());

        craftGrimLeggings.shape("ICI","C C","C C");
        craftGrimLeggings.setIngredient('I', new RecipeChoice.ExactChoice(RefinedCopperUtil.giveIngot()));
        craftGrimLeggings.setIngredient('C',new RecipeChoice.ExactChoice(GrimReaperArmorUtil.giveUndeadChains()));

        Bukkit.getServer().addRecipe(craftGrimLeggings);
    }
    private static void createGrimBoots(){
        ShapedRecipe craftGrimBoots = new ShapedRecipe(NamespacedKey.minecraft("grim_boots"), GrimReaperArmorUtil.giveGrimBoots());

        craftGrimBoots.shape("   ","C C","I I");
        craftGrimBoots.setIngredient('I', new RecipeChoice.ExactChoice(RefinedCopperUtil.giveIngot()));
        craftGrimBoots.setIngredient('C',new RecipeChoice.ExactChoice(GrimReaperArmorUtil.giveUndeadChains()));

        Bukkit.getServer().addRecipe(craftGrimBoots);
    }
}